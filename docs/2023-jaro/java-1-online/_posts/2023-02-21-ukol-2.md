...
- Nejprve uděláš *fork* projektu z mého repository do tvého. Nyní máš na svém účtu na GitHubu projekt `j1-ukol02`.
...
- Do tabulky s úkoly ke svému jménu přidáš klikatelný odkaz na tvé repository na GitHubu (zkopíruješ z adresního řádku prohlížeče adresu ve tvaru `https://github.com/<tvůj login na GitHubu>/j1-ukol02`, Google Drive z toho udělá odkaz automaticky).

📅 Termín pro odevzdání úkolu je půlnoc (23:59) **v neděli 24. 4.**
