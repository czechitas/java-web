...
* Spring Boot:
  ...
  * nyní použijeme verzi **3.5.8**
  * nejnovější verze je 4.0.0, ale ta byla vydána 20. listopadu 2025 – s ní ještě experimentovat nebudeme
  * nepoužívejte vývojové verze (SNAPSHOT, ALPHA nebo BETA)
* Packaging: Jar
* Java:
  * doporučuji nejnovější LTS, ale pár měsíců po vydání je lepší počkat a používat ještě starší LTS verzi, než se všechny nástroje přizpůsobí a otestují  novou verzí
    * nejnovější verze LTS je 25 vydaná v září 2025
    * během kurzu jsme používali LTS verzi 21
  * aktuální [LTS verze](https://www.oracle.com/java/technologies/java-se-support-roadmap.html) (Long Term Support) jsou 8, 11, 17, 21 a a 25 (verze 8 a 11 už mají jen rozšířenou podporu; příští LTS verze by měla být 29 s vydáním v září 2027)
